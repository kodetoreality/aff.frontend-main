...
import { Col, Input, Button,Card,CardBody,FormGroup} from "reactstrap"
...
class ChangePassword extends React.Component{
    ...
    save_password = (e) => {
        ...
        if(jwt_ed(this.state.current_pass) !== this.props.users.values.password){
            this.setState({ cisValid: false });
        }else{
                ...
                <Card>
                    <CardBody className="pt-1" style={{color:"white"}}>
                        <Col lg="12" md="12" xs="12" style={{padding:"4vw"}}>
                            ...
                            Kasagames admin ChangePassword
                            </h2>
                            ...
                            <Button.Ripple color="success" className="mr-1"  onClick={this.save_password} >Save
                            </Button.Ripple>
