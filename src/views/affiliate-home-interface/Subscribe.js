...
class Subscribe extends Component {
    ...
    render() {
        return (
            <section id="Subscribe" className="section subscribe-area ptb_100">
                <div className="container">
                    ...
                    <div className="col-12 col-md-10 col-lg-7">
                        ...
                        <form className="subscribe-form">
                            ...
                            <button type="submit" className="btn btn-lg btn-block" style = {{color : 'white'}}>{this.state.initData.submitText}</button>
                        </form>
                        </div>
                    </div>
                    </div>
