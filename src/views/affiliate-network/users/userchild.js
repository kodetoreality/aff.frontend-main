...
import {UncontrolledDropdown, DropdownMenu, DropdownToggle, DropdownItem, Input, Col, Row, Badge, Button, FormGroup, Label, Modal, Form, ModalHeader, ModalBody, ModalFooter} from "reactstrap"
import {Status , Role , Countrys , Currency , FilterBy } from "../../../configs/affiliateConfig.js"
            ...
            <Col lg='3' md='3' sm='3' xs='6'>
              <FormGroup>
                ...
                <Select
                  ...
                  onChange={e => handleFilter(e.value,CURRENCY)}
                />
              </FormGroup>
            </Col>
          </Row>
      ...
      <Row className ={expandClassname}>
        ...
        <Col lg='3' md='3' sm='6' xs='12'>
          <Button
            ...
            outline>
            <Plus size={15} />
            <span className="align-middle" color="primary" style = {{color : 'white'}}> Create User </span>
          </Button>
          <Button
            style={{float:'right' , color : 'white'}}
...
class ListViewConfig extends Component {
  ...
  state = {
    ...
    columns: [
      ...
      },
      {
        ...
        cell: row => (
          <Badge
            color={ row.permission === "admin" ? "light-warning" : "light-success"}
            pill>
            {row.permission}
          </Badge>
        )
  ...
  handleView = (data) => {
    history.push(`Users/Account?user=${data.id}`)
  }

  handleLogin = (data) => {
    this.props.loginWithJWT(data);
  }
