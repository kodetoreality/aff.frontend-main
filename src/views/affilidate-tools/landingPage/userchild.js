...
import { ChevronDown,  ChevronLeft,  ChevronRight, Eye, Delete, Plus, Search, Edit,Edit2} from "react-feather"
...
const CustomHeader = props => {
  ...
  return (
    <div className= "p-1 pt-2 pb-2" style = {{borderRadius : "10px"}}>
      <Row>
        <Col>
          <p> Filters </p>
        </Col>
...
class ListViewConfig extends Component {
    ...
    columns: [
      {
        ...
        cell: row => (
          <ActionsComponent
            ...
            handleIndicate={this.handleIndicate}
          />
        )
      },
      {
        name: "Marketing Source Id",
        selector: "id",
        sortable: true,
        minWidth: "50px",
      },
  ...
  handleIndicate = () => {
    this.setState({indicate : !this.state.indicate})
  }

  handleIndicateFirst = (flag) => {
    this.handleIndicate();

    console.log()

    if(flag === 1){
      this.handleIndicateSecond_1()
    }else if(flag === 2){
      this.handleIndicateSecond_2()
    }
  }

  handleIndicateSecond_1 = () => {
    this.setState({indicate_1 : !this.state.indicate_1})
  }
  
  handleIndicateSecond_2 = () => {
    this.setState({indicate_2 : !this.state.indicate_2})
  }
    ...
    return (
      <div id="admindata_table" className={`data-list list-view`}>
        ...
        <Indicate
          show={indicate}
          handleIndicate={this.handleIndicate}
          handleIndicateFirst={this.handleIndicateFirst}
        />
        <IndicateAfter1
          show={indicate_1}
          handleIndicate={this.handleIndicateSecond_1}
        />
        <IndicateAfter2
          show={indicate_2}
          handleIndicate={this.handleIndicateSecond_2}
        />
      </div>
    )
  }
