...
import { Label, Input, FormGroup ,Form,Button, Modal, ModalHeader, ModalBody, ModalFooter,Col,Row,CustomInput} from "reactstrap"
      ...
      <Modal isOpen={this.props.show} toggle={this.toggleModal} className="modal-dialog-centered modal-mg">
        ...
        <Form className="" action="#" onSubmit={this.handleregister}>
          ...
          <ModalBody className="mt-1">
            ...
            <Col>
              <FormGroup>
                <Label for="currency">Domain</Label>
                <Select
                  className="React"
            ...
            <Col>
              <FormGroup>
                <Label for="currency">Landing Pages</Label>
                <Select
                  className="React"
                  classNamePrefix="select"
                  id="currency"
            ...
            <Col>
              <FormGroup>
                <Label for="currency">Marketing Sources</Label>
                <Select
                  className="React"
                  classNamePrefix="select"
                  id="currency"
